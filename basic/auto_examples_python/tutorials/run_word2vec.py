...
# #. Demonstrates training a new model from your own custom
...
# window across text custom, and trains a 1-hidden-layer neural network based on
...
# -----------------------
#
# To start, you'll need some custom for training the model.  For the following
