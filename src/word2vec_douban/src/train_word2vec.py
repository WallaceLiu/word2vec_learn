...
#################### config ###################
#custom = "../custom/review_douban_movie.tsv.removeword"
#custom = "../custom/test_corpus.csv.removeword"
#custom = "../custom/zhidao_dataneg.tsv.removeword"
data = "../custom/wv_train.custom"
parser = argparse.ArgumentParser()
parser.add_argument("-train",       type=str, default=data, help="Use text custom from file TRAIN to train the model")
...
parser.add_argument("-sample",      type=float,default=1e-3,help="Set threshold for occurrence of words. Those that appear with higher frequency in the training custom will be randomly down-sampled; default is 1e-3, useful range is (0, 1e-5)")
