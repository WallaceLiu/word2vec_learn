...
class MyCorpus(object):
    ...
    def __iter__(self):
        corpus_path = '../txt/jinYong_segment.txt'
...
# 张三丰 may be error, because this txt just only have two words
# 张君宝 is ok, this txt is 88 words
vec_king = model.wv['张君宝']
...
# temporary_filepath = '../txt/jinYong_vector2.txt'
